      ...
      <?php if(isset($_SESSION['HM_uid'])) {?>
        <?php if($_SESSION['HM_ver_status'] == false) {?>
          <div class="alert alert-warning alert-dismissible fade show" role="alert">
            <strong>Xác minh email.</strong> Xác minh địa chỉ email của bạn
          ...
          <div class="booking-cont">
            ...
            <div class="booking-details">
              ...
              <p><small><b>Chi tiết đặt chỗ:</b></small></p>
                ...
                <div class="form-group">
                  <label for="exampleInputEmail1"><strong>Tổng giá</strong></label>
                  <input type="text" class="form-control total-price" name="price" value="Kshs <?php echo $room["price"]; ?>">
                </div>
                <p><small><b>Thông tin cá nhân:</b></small></p>
                <?php if(isset($_SESSION["HM_uid"])) {?>
                  <div class="row">
                    <div class="col">
                        <div class="form-group">
                ...
                <?php } ?>
                <div class="form-group">
                  <input class="btn btn-primary btn-block" type="submit" value="Lưu trữ">
                </div>
              </form>
            </div>
          </div>
