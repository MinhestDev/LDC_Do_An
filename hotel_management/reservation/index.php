...
<html lang="en">
  ...
  <body>
    <section class="header">
        ...
        <a href="./dashboard.php" class="mb-4 btn1" style="color: fff; font-weight: bold;"> Đến trang dashboard</a>
            <div class="form-cont">
                ...
                <div class="form-group">
                    <label for="exampleInputEmail1">Ngày ra:</label>
                ...
                <div class="form-group"><button type="submit" class="btn btn-secondary">Xem phòng</button></div>
            </div> 
        </form>
    </section>
    <section class="rooms">
        <div class="rooms-cont">
            ...
            <div class="room">
                ...
                <div class="price">
                    <p class="price"><?php echo $room["price"] ?> /1 đêm.</p>
                </div>
                <a href="./book.php?rid=<?php echo $room["roomid"]; ?>" class="btn btn-block btn-primary">Đặt phòng</a>
            </div>
            <?php } ?>
        </div>
    </section>
