...
if($_SERVER['REQUEST_METHOD'] === 'POST') {
   ...
   if(!$ref_obj) {
      $errors["pwd"] = "Yêu cầu không thành công. Yêu cầu không hợp lệ.";
   } else {
...
<html lang="en">
  ...
  <body>
        <form class="add-form" method="POST" style="max-width: 468px; margin: 0 auto;">
            <h3 style="text-align: center">Làm mới mật khẩu</h3>
            <hr>
            ...
            <button type="submit" class="btn btn-primary btn-block">Làm mới mật khẩu</button>
        </form>
