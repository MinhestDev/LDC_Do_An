  ...
  <body>
        ...
        <div class="container">
            ...
            <ul class="navbar-nav mr-auto">
                <li class="nav-item active">
                    <a class="nav-link" href="./index.php">Phòng <span class="sr-only">(hiện tại)</span></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="../bookings/" class="active">Nhận phòng khách</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="../reservations/" class="active">Sự đặt chỗ</a>
                </li>
                <li class="nav-item">
    ...
    <div class="container">
        <div style="display: flex; gap: .4rem; align-items: center;">
            <a href="../rooms/addroom.php" class="btn btn-primary my-5">Tạo phòng mới</a>
            <form method="POST">
