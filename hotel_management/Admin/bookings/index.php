...
include_once("../reports.php");
   ...
   if($_SERVER["REQUEST_METHOD"] === "POST") {
      ...
      if(!$res) {
         $response_text ="Tham chiếu vé không hợp lệ.";
      } else {
         $response_text = "Xác thực vé thành công.";
         $is_positive = true;
         $ref_no = "";
      }
   }
...
<html lang="en">
  ...
  <body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
               <ul class="navbar-nav mr-auto">
                  ...
                  <li class="nav-item">
                     <a class="nav-link" href="./index.php" class="active">Nhận phòng khách</a>
                  </li>
                  <li class="nav-item">
                     <a class="nav-link" href="../reservations/" class="active">Đặt phòng</a>
                  </li>
                  <li class="nav-item">
                     <a class="nav-link" href="../businessinteligence/" class="active">Tình báo kinh doanh</a>
                  </li>
                  <li class="nav-item">
    ...
    <div class="container my-4">
      <h3>Nhận phòng khách</h3><hr>
      <form  method="POST" class="mb-4" style="width: 60%;">
         <?php if($response_text) { ?>
            <?php if($is_positive){  ?>
               <div class="alert alert-success alert-dismissible fade show" role="alert">
                  <strong>Xác thực thành công.</strong> <?php echo $response_text ?>
            ...
            <?php } else { ?>
               <div class="alert alert-danger alert-dismissible fade show" role="alert">
                  <strong>Xác thực không thành công.</strong> <?php echo $response_text ?>
                  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                     <span aria-hidden="true">&times;</span>
                  </button>
               </div>
         ...
         <div class="input-group">
           <input type="text" required class="form-control" placeholder="Nhập số tham chiếu" name="refno" value=<?php echo $ref_no ?>>
           <div class="input-group-append">
             <button type="submit" class="btn btn-primary">Nhận phòng khách</button>
           </div>
         </div>
      </form>
        <table class="table custom-table my-3">
           <thead>
              <tr>
                 ...
                 <th scope="col">Đăng ký vào</th>
                 <th scope="col">Đăng ký ra</th>
                 <th scope="col">Giá</th>
              </tr>
           </thead>
           <tbody>
