    ...
    <script type="text/javascript">
      ...
      function drawChart() {
         query_data().then(data => {
            ...
            var materialOptions = {
               chart: {
                  title: 'Doanh thu Muong Thanh Hotel',
                  subtitle: 'Lợi nhuận năm tài chính 2022 - 2023'
               },
               hAxis: {
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
         query_data().then(data => {
            ...
            var materialOptions = {
               chart: {
                  title: 'Đặt phòng Muong Thanh',
                  subtitle: 'Số lượng đặt phòng cho mỗi bộ'
               },
               hAxis: {
                  title: 'Đặt phòng'
               },
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
               <ul class="navbar-nav mr-auto">
                  ...
                  <li class="nav-item">
                     <a class="nav-link" href="./index.php" class="active">Tình báo kinh doanh</a>
                  </li>
                  <li class="nav-item">
