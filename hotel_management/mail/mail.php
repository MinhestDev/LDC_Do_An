...
if($_SERVER["REQUEST_METHOD"] == "GET") {
    if($_GET["type"] === "verification") {
        $email_body = "
            <html>
                ...
                <body style=\"padding: 24px; text-align: center; background-color: white;\">
                    <h4>ĐẶT PHÒNG | Xác nhận địa chỉ email.</h4><br>
        ...
        $email_body = "
            Cảm ơn bạn đã chọn Mường Thanh Hotel. Chúc bạn có một trải nghiệm tuyệt vời!
            <html>
                <head></head>
                <body style=\"padding: 24px; text-align: center; background-color: white;\">
                    <h1>MƯỜNG THANH HOTEL | Thanh toán</h1>
                    <p>Thanh toán nhận được thành công. Tham chiếu thanh toán: <span style=\"font-size: 24px;\" >".$ref_no."</span> </p><br>
                    ...
                    <tr>
                        ...
                        <td>". $room_no . "</td>
                        <td>". $price . "</td>
                        <td>". $ref_no . " (KHÔNG CHIA SẺ NÀY VỚI BẤT CỨ AI)</td>
                    </tr>
                    </table>
                </body>
            </html>
        ...
        $email_body = "
            <html>
                <head></head>
                <body style=\"padding: 24px; text-align: center; background-color: white;\">
                    <h4>MUONG THANH HOTEL | Đặt lại mật khẩu.</h4><br>
